import { PageNumberFormatter, format, applyTemplate, formatWithTemplate } from '../../../src/modules/page-numbering/formatter.js';
...
describe('PageNumberFormatter', () => {
  ...
  describe('applyTemplate', () => {
    ...
    test('throws error for invalid template', () => {
      expect(() => formatter.applyTemplate('5', null, null)).toThrow('Template must be a non-empty string');
